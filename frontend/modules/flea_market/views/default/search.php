                ...
                <?php foreach($search as $s): ?>
                   ...
                   // \common\classes\Debug::prn($s->favorites[0]);
                    ...
                    <div class="fleamarket__ads__item">
                        <a href="<?= \yii\helpers\Url::to(['view','slug'=>$s->slug, 'id' => $s->id])?>" class="fleamarket__ads__item--img">
                            <img src="/<?=$img?>" alt="">
                        ...
                        <div class="fleamarket__ads__item--desc">
                            ...
                            <a href="<?= \yii\helpers\Url::to(['view','slug'=>$s->slug, 'id' => $s->id])?>" class="fleamarket__ads__item--desc--title"><?=$s['name']?></a>
